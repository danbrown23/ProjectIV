...
m = squeeze(mean(mdata(2,4000:20000,:),2));

figure
scatter(blist,m,80,'filled')
xlabel("CCC Noise Amplitude")
ylabel("Mean Niche Width")

figure

nspec = mean(ndata(4000:20000,:),1);
...
figure
scatter(logb,logm,80,'filled')
xlabel("CCC Noise Amplitude")
ylabel("Log Mean Number of Distinct Species")

figure
scatter(logb,lognspec,80,'filled')
xlabel("CCC Noise Amplitude")
ylabel("Log Mean Number of Distinct Species")