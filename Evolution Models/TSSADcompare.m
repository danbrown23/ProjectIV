...
function X = effectivecarryingcapacity(x,sd_K,sd_a,n) % (assume no species go extinct)
...
function s = selectiongradient(x,sd_K,sd_a,n)
    ...
    X = effectivecarryingcapacity(x,sd_K,sd_a,n);
